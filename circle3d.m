...
%---------------------------------------------------------------------%
%-                               CIRCLE3D                           --%
%-      Returns array containing location of nodal circular cross   --%
%-      sectional area.                                             --%
%-                             Andrew Young                         --%
%-                           Updated 4/17/2015                      --%
%-                             Project 1263                         --%
...
%   r - radius of circle
%   cent - center of circle (column)
%   orient - orientation point (column)
%   v_norm - normal vector to circle center (column)
%   xyz - coordinates of circle (n x 3 matrix)
%   n - Number of points
